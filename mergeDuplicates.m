function mergeDuplicates(filename)

    if nargin == 0
        filename = '../data/Venous_subnwk_duplicates/KF_WM_TV_rCRV_fixed';
    end

    WMFilename = '/Users/lavanyavaddavalli/Desktop/lppd/tools_latest/data/KF_WM_TV_straight_LCC';
    %newFilename = filename;
    newFilename = '../data/Venous_subnwk_duplicates/KF_WM_TV_rCRV_fixed1';
    ...
    nwkHelp.save(newFilename, new_nwk);
